...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            @include('layouts.admin.sash.body.header')

            @include('layouts.admin.sash.body.sidebar', [
                'page_attr' => $page_attr,
        ...
        @include('layouts.admin.sash.body.footer')
    ...
    <!-- Sticky js -->
    <script src="{{ asset_admin('js/sticky.js', name: 'sash') }}"></script>

    <!-- CHART-CIRCLE JS-->
    <script src="{{ asset_admin('js/circle-progress.min.js', name: 'sash') }}"></script>

    <!-- SIDEBAR JS -->
    <script src="{{ asset_admin('plugins/sidebar/sidebar.js', name: 'sash') }}"></script>

    <!-- SIDE-MENU JS-->
    <script src="{{ asset_admin('plugins/sidemenu/sidemenu.js', name: 'sash') }}"></script>
    ...
    {{-- scroll --}}
    <script src="{{ asset_admin('plugins/p-scroll/perfect-scrollbar.js', name: 'sash') }}"></script>
    <script src="{{ asset_admin('plugins/p-scroll/pscroll.js', name: 'sash') }}"></script>
    <script src="{{ asset_admin('plugins/p-scroll/pscroll-1.js', name: 'sash') }}"></script>
